...
export default function SetPhoto(props) {
  ...
  return (
    <>
      <div className="flex justify-around w-[48.5rem]">
        <div className="img div wrapper w-[30rem] grid justify-center">
          <div className="bg-darkcho w-20 h-20 rounded-full overflow-hidden">
            <img className="w-full h-full" src={props.oldProfile} alt="img" />
          </div>
        </div>
        <div>
          <div className="h-20 grid content-center">
            <Button
              ...
              className="bg-gray-400 hover:bg-olive"
            >
